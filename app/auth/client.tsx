...
export default function Client({ redirectTo }: ClientProps) {
  ...
  const content = useMemo(() => {
    if (mode === "signup") {
      return {
        id: "signup",
        title: "Create your InboxPilot account",
        description: "Join InboxPilot to start sending campaigns in seconds.",
      };
    }

    return {
      id: "signin",
      title: "Sign in to InboxPilot",
      description: "Manage your email campaigns, templates, and lists from your InboxPilot dashboard.",
    };
  }, [mode]);
          ...
          <div className="relative z-10 flex h-full flex-col justify-between">
            <div className="space-y-4">
              ...
              <h1 className="max-w-sm text-4xl font-semibold leading-tight tracking-tight">
                Email Marketing Made Effortless
              </h1>
              <p className="max-w-md text-sm text-muted-foreground">
                Manage contacts, design campaigns, and analyze results — all from one place.
              </p>
            </div>
